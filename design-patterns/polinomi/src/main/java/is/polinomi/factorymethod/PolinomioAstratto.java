...
public abstract class PolinomioAstratto implements Polinomio {
    ...
    protected abstract void addMod(Monomio m);
    /**
     ...
     * {@link Polinomio}
     */
    protected abstract PolinomioAstratto create();

    @Override
    public Polinomio add(Monomio m) {
        PolinomioAstratto p = create();
        boolean added = false;
    ...
    public Polinomio add(Polinomio p) {
        PolinomioAstratto somma = create();// crea un nuovo polinomio
        for (Monomio m : this)
    ...
    public Polinomio mul(Monomio m) {
        PolinomioAstratto prodotto = create();// crea un nuovo polinomio
        for (Monomio m1 : this)
    ...
    public Polinomio mul(Polinomio p) {
        PolinomioAstratto prodotto = create();// crea un nuovo PolinomioF
    ...
    public Polinomio derive() {
        PolinomioAstratto p = create();// crea un nuovo polinomio
        for (Monomio m : this) {
            int grado = m.grado();
