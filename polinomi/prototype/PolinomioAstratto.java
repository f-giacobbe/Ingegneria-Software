...
public abstract class PolinomioAstratto implements Polinomio, Cloneable {
	...
	public Polinomio add(Polinomio p) {
		Polinomio somma = PolinomioFactory.createPolinomio();// crea un nuovo polinomio
		for (Monomio m : this)
	...
	public Polinomio mul(Monomio m) {
		Polinomio prodotto = PolinomioFactory.createPolinomio();// crea un nuovo polinomio
		for (Monomio m1 : this)
	...
	public Polinomio mul(Polinomio p) {
		Polinomio prodotto = PolinomioFactory.createPolinomio();// crea un nuovo PolinomioF
	...
	public Polinomio derive() {
		Polinomio p =PolinomioFactory.createPolinomio();// crea un nuovo polinomio
		for (Monomio m : this) {
			int grado = m.grado();
